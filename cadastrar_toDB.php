    ...
    <div class="container">
        <div class="row">
          <?php
            ...
            $sql = "INSERT into `agendamento`(`id_funcionario`,`data_agendamento`, `hora_agendamento`,`tipo_animal`, `nome_cliente`) VALUES ($idfuncionario, '$data_agendamento', '$hora_agendamento','$tipoanimal', '$nomecliente')";
